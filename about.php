...
<?php include("header.php"); ?>
    ...
    <!-- banner -->
                    ...
                    <div class="container">
                       ...
                       is just a bag or product that is the number one brand in Thailand
	that is popular and known by Thais. Caring about the brand's self in every use, customers can use GOTCHA to use anytime, anywhere to enhance. Build confidence and prevent customers from missing opportunities from the GOTCHA bag brand
        ...
        <div class="gallery row no-gutters pt-lg-5">
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="images/home/g1.jpg" class="img-fluid" alt="" />
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="images/home/g2.jpg" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="images/home/g3.jpg" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="images/home/g4.jpg" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 60</li>
                        <li class="gallery-item-comments">
                            <i class="fas fa-comment"></i> 6</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="images/home/g5.jpg" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="images/home/g6.jpg" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 45</li>
                        <li class="gallery-item-comments">
                            <i class="fas fa-comment"></i> 3</li>
                    </ul>
                </div>
        ...
        <div class="gallery row no-gutters pb-5">
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                ...
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 79</li>
                        <li class="gallery-item-comments">
                            <i class="fas fa-comment"></i> 4</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="images/home/g9.jpg" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 42</li>
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="images/home/g10.jpg" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 38</li>
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="images/home/g11.jpg" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 55</li>
                        <li class="gallery-item-comments">
                            <i class="fas fa-comment"></i> 8</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="images/home/g12.jpg" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 49</li>
                        <li class="gallery-item-comments">
                            <i class="fas fa-comment"></i> 4</li>
                    </ul>
                </div>
