  ...
  ?>
      ...
      <div id="demo" class="collapse">
        <p>
          ...
          ///////////หาค่า max ของ id
          //include("Connection_inct4.php"); $link = connectToDB();//ติดต่อฐานข้อมูล
          $sql_select   = "SELECT max(id_dealer) as newID FROM dealer"; //คำสั่งคิวรี่
          ...
          ?><form id="form1" name="form1" method="post" action="in_dealer_new.php" enctype="multipart/from-data">
          <section class="page-section cta">
          <div class="container"> 
              <table class="table table-striped table-bordered">
                  <thead>
                      <tr>
                          <th width="30" bgcolor="#FFCC99"><font size="3">id_dealer</font></a></p>
                          รหัสผู้จัดจำหน่าย</th>
                          <th width="50" bgcolor="#FFCC99"><font size="3">name_dealer</font></a></p>
                          ชื่อผู้จัดจำหน่าย</th>
                          <th width="30" bgcolor="#FFCC99"><font size="3">address</font></a></p>
        ...
        <tr>
          <th align="left">&nbsp;
            <label for="id_dealer"></label>
            <input name="id_dealer" type="text" readonly="readonly" style="background:#999" id="id_dealer" value="<?= $newID ?>" size="5" /></th>
          <th align="left"><input type="text" name="name_dealer" /></th>
      ...
      <section class="page-section cta">
          <div class="container"> 
              <table class="table table-striped table-bordered">
                  <thead>
                      <tr>
                      <th width="66" bgcolor="#FFCC99"><font size="3">แก้ไข</font></a></th>
                      <th width="43" bgcolor="#FFCC99"><font size="3">ลบ</font></a></th>
                          <th width="150" bgcolor="#FFCC99"><font size="3">id_dealer</font></a></p>
                          รหัสผู้จัดจำหน่าย</th>
                          <th width="150" bgcolor="#FFCC99"><font size="3">name_dealer</font></a></p>
                          ชื่อผู้จัดจำหน่าย</th>
                          <th width="150" bgcolor="#FFCC99"><font size="3">address</font></a></p>
                          ที่อยู่ผู้จัดจำหน่าย</th>
            ...
            $sql_select = " SELECT * FROM dealer order by $sortby "; //คำสั่งคิวรี่
        ...
        <tbody id="myTable">
          <tr>
            <th align="center"><a href="in_dealer_edit.php?id=<?= $id_dealer ?>">แก้ไข</a></th>
            <th align="center"><a href="in_dealer_delete.php?id=<?= $id_dealer ?>">ลบ</a></th>
            <th height="52" align="center">
              <p><?php echo $id_dealer; ?></p>
            </th>
           
            <th align="center"><?php echo $name_dealer; ?></th>
