...
include("Connection_inc4.php"); $link = connectToDB();//ติดต่อฐานข้อมูล		   
	  $id=$_GET['id'];
	  $sql_select="SELECT * FROM dealer where id_dealer='$id'";//คำสั่งคิวรี่
...
?>	  
	...
	<tr>
        ...
        <input name="id_dealer" type="text"  readonly="readonly"  
		style="background:#999" id="id_dealer" value="<?=$id_dealer?>"  size="5" /></th>
        <th align="left"><input type="text" id="name_dealer" value="<?=$name_dealer?>"  name="name_dealer" /></th>
        <th align="left"><input type="text" id="address" value="<?=$address?>"  name="address" /></th>
       </tr>
	   <tr>
