   ...
   <!-- //shopping cart ends here -->
      ...
      <!-- //header -->
        <div class="container">
            ...
            <form action="checklogis2.php" method="post" enctype="multipart/form-data" name="form2">
              <p>
              ...
              <table width="100%" border="0">
                <tr>
                  <td width="45%"></td>
                  <td width="55%">ยืนยันการจัดส่ง</td>
                </tr>
                <tr>
                  <td><p>OrderID
                    <label for="select"></label>
    <select name="select" id="select"   
    onChange="if(this.value*1!=0){pic.value=this.value;}
    else{ pic.value='';}"   >
        <option value="0">กรุณาเลือก OrderID</option>
                    ...
                    <label for="picName"></label>
                      ...
                      <input name="EmployeeValidate"  readonly style="background:#CCC"  value="<?=$_SESSION['employee']['EmployeeID']?>" type="text" required id="EmployeeValidate" maxlength="10">
                
					<p>รายการสินค้าในบิลนี้ทั้งหมด
					<textarea name="pic" class="form-control" rows="5" cols="5" id="pic"></textarea>
						</p>
					<p>ที่อยู่ในการจัดส่ง
                      <label for="address"></label>
                      <textarea name="address" cols="70" rows="2" id="address"></textarea>
                    </p>
                    <p>สถานะ
                      <label>
                        <input required type="radio" name="StatusValidate" value="1" id="ToBank_0">
                        ส่งเรียบร้อยแล้ว</label>
                      <label>
