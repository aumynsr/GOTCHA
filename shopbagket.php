...
<body>
              ...
              <div class="col-lg-8 mx-auto">
                ...
                <div class="form-group">
                            ...
                            <p class="text-center mt-3">คุณเป็นสมาชิกอยู่แล้ว?
                                <a href="myModal_btn1" data-toggle="modal" data-target="#portfolioModal2" class="text-dark login_btn">
                                    Login Now</a>
                                ...
                                <div class="px-0 container">
                                    <div class="row">
                                        <div class="col-md-10">
											...
											<a class="dropdown-item" href="shouderbag.html">Small Shoulder Bags</a	>										
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Bagket Bags</li>
		</ol>
	</nav>
	<!-- //breadcrumbs -->
	<!-- Shop -->
	<div class="innerf-pages section">
		<div class="fh-container mx-auto">
			<div class="row my-lg-5 mb-5">
              ...
              <img class="img-fluid" src="images/gotcha/got7.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Naps Micro Fiber Grey</h2>
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got7.jpg" alt="">
				  <br><h6><B>
				 ...
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    ...
                    <li><B>Size :  </B><font color="red">mini</font></li>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button>
								...
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Naps Micro Fiber Grey</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,900.00</p>
										<p class="line-through">฿2,100.00</p>
									</div>
								</div>
								<!-- card footer -->
              ...
              <img class="img-fluid" src="images/gotcha/got12.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Naps Micro Fiber Pink</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got12.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Pink</font></li>
                    <li><B>Size :  </B><font color="red">mini</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
...
<br>
				 <p>สามารถใส่ของจุกจิก,เงิน,บัตร,กุญแจ,แป้งพับ,ลิปสติก </p>
                  ...
                  <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Naps Micro Fiber Pink</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,900.00</p>
										<p class="line-through">฿2,100.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got13.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Naps Micro Fiber White</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got13.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">White</font></li>
                    <li><B>Size :  </B><font color="red">mini</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Naps Micro Fiber White</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,900.00</p>
										<p class="line-through">฿2,100.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got8.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Leopold Black crossbody(2 สาย)</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got8.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Leopold Black crossbody</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,580.00</p>
										<p class="line-through">฿1,780.00</p>
									</div>
								</div>
								<!-- card footer -->
								<div class="card-footer d-flex justify-content-end">
              ...
              <img class="img-fluid" src="images/gotcha/got9.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Leopold Grey crossbody(2 สาย)</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got9.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Leopold Grey  crossbody<br>(2 สาย)</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,580.00</p>
										<p class="line-through">฿1,780.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got11.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Leopold Light Nude crossbody(2 สาย)</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got11.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Light Nude </font></li>
                    <li><B>Size :  </B><font color="red">mini</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">20</font></li>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Leopold Light Nude crossbody (2 สาย)</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,580.00</p>
										<p class="line-through">฿1,780.00</p>
									</div>
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3 out_w3">
									<div class="men-thumb-item position-relative">
										<img src="images/gotcha/got55.jpg" alt="img" class="card-img-top" style="width:200px;height:200px">
										<span class="px-2 position-absolute">out of stock</span>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Gotcha Mini Signature Crossbody Bag Light Grey</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">฿1,690.00</p>
											<p class="line-through">฿1,990.00</p>
										</div>
									</div>
									<!-- card footer -->
									<div class="card-footer d-flex justify-content-end">
              ...
              <img class="img-fluid" src="images/gotcha/got14.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Passa Vanilla Cream</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got14.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Cream </font></li>
                    <li><B>Size :  </B><font color="red">Normal</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">10</font></li>
					<br>
					 
				<B>Details</B>

<br>
				 <p>สามารถใส่กระเป๋าเงินใบยาวได้ ใส่โทรศัพท์ iphone plus ได้</p>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Passa Vanilla Cream Printed</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿2,070.00</p>
										<p class="line-through">$2,220.00</p>
									</div>
								</div>
								<!-- card footer -->
								<div class="card-footer d-flex justify-content-end">
              ...
              <img class="img-fluid" src="images/gotcha/got15.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Passa Black Printed</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got15.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
				 ...
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    ...
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">12</font></li>
					<br>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Passa Black Printed</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿2,070.00</p>
										<p class="line-through">$2,220.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got16.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Passa Grey Printed</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got16.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
				 ...
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    ...
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">21</font></li>
					<br>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Passa Grey Printed</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿2,070.00</p>
										<p class="line-through">$2,220.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got18.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Moon two sided Khaki</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got18.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Khaki </font></li>
                    <li><B>Size :  </B><font color="red">Normal</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">22</font></li>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Moon two sided Khaki</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,980.00</p>
										<p class="line-through">฿2,180.00</p>
									</div>
								</div>
								<!-- card footer -->
								<div class="card-footer d-flex justify-content-end">
              ...
              <img class="img-fluid" src="images/gotcha/got19.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Moon two sided Grey</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got19.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
...
<br>
				...
				<p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Moon Two Sided Grey</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,980.00</p>
										<p class="line-through">฿2,180.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got20.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Moon two sided Black</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got20.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
				 ...
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    ...
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">15</font></li>
					<br>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Gotcha Moon Two Sided Black</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,980.00</p>
										<p class="line-through">฿2,180.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got23.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Mini Signature Cross Body White</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got23.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Mini Signature Cross Body White</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,200.00</p>
										<p class="line-through">฿1,490.00</p>
									</div>
								</div>
								<!-- card footer -->
								<div class="card-footer d-flex justify-content-end">
              ...
              <img class="img-fluid" src="images/gotcha/got24.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Mini Signature Cross Body Grey</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got24.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
...
<br>
				 <p>สามารถใส่กระเป๋าเงินใบยาวได้ ใส่โทรศัพท์ iphone plus ได้</p>
                  ...
                  <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Mini Signature Cross Body Grey</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,200.00</p>
										<p class="line-through">฿1,490.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got25.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Mini Signature Cross Body Khaki</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got25.jpg" alt="">
				 <br> <h6><B>
                            The description</h6></B>
				 ...
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    ...
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">18</font></li>
					<br>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Mini Signature Cross Body Khaki</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,200.00</p>
										<p class="line-through">฿1,490.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got27.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Mini Signature Cross Body Charcoal</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got27.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Charcoal </font></li>
                    <li><B>Size :  </B><font color="red">Mini</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">15</font></li>
...
<br>
				 <p>สามารถใส่กระเป๋าเงินใบยาวได้ ใส่โทรศัพท์ iphone plus ได้</p>
				  ...
				  <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Mini Signature Cross Body Charcoal</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,200.00</p>
										<p class="line-through">฿1,490.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got28.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Mini Signature Cross Body Black</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got28.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Mini Signature Cross Body Black</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,200.00</p>
										<p class="line-through">฿1,490.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got29.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Moon two sided Plum</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got29.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Plum </font></li>
                    <li><B>Size :  </B><font color="red">Normal</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">22</font></li>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Gotcha Moon two sided Plum</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,980.00</p>
										<p class="line-through">฿2,180.00</p>
									</div>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got30.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Gotcha Moon two sided Grey</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,980.00</p>
										<p class="line-through">฿2,180.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got31.jpg" alt="">
            </a>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got31.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
...
<br>
              ...
              <img class="img-fluid" src="images/gotcha/got35.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">GOTCHASUP Grey</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got35.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
...
<br>
				 <p>สามารถใส่กระเป๋าเงินใบยาวได้ ใส่โทรศัพท์ iphone plus ได้</p>
				  ...
				  <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">GOTCHASUP Grey</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,690.00</p>
										<p class="line-through">฿1,990.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got38.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">GOTCHASUP Pink</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got38.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
				 ...
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    ...
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">23</font></li>
					<br>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">GOTCHASUP Pink</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,690.00</p>
										<p class="line-through">฿1,990.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got39.jpg" alt="">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">GOTCHASUP Black</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสะพาย</p>
				   <div class="caption">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got39.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
...
<br>
				 ...
				 <p> <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button></p>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">GOTCHASUP Black</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿1,690.00</p>
										<p class="line-through">฿1,990.00</p>
									</div>
              ...
              <img class="img-fluid" src="images/gotcha/got41.jpg" alt="">
            </a>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="images/gotcha/got41.jpg" alt="">
				  <br><h6><B>
                            The description</h6></B>
