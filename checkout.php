...
<body>
    ...
    <section class="page-section cta">
	  ...
	  <table class="table table-striped table-bordered">
                      ...
                      <img src="img/got8.jpg" alt="Image" class="img-fluid" style="width:200px;height:200px">
                    </td>
					
					<td class="product-id">
                      <h2 class="h5 text-black">0013</h2>
                    </td>
					
					
					<td class="product-id">
                      <h2 class="h5 text-black">Leopold Black crossbody(2 สาย)</h2>
                    </td>
					...
					<td class="product-id">
                      <h2 class="h5 text-black">1,580.00</h2>
                    </td>
							...
							<tr>
                                <td colspan="8" style="text-align: right;">
                                	...
                                	<a href="index.html" type="button" class="btn btn-danger btn-lg">ย้อนกลับ</a>
                                    <a button type="submit" class="btn btn-primary btn-lg" >สั่งซื้อสินค้า<a>
                                </td>
                            </tr>
