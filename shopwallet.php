...
<body>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Wallet Bags</li>
		</ol>
	</nav>
	<!-- //breadcrumbs -->
	<!-- Shop -->
              ...
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
				 ...
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Sugar Brown </font></li>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Blue</font></li>
                    <li><B>Size :  </B><font color="red">mini</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
				  ...
				  <ul class="list-inline">
				 <li>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
				...
				<br>
                 ...
                 <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Gotcha Huncha Cardholder Fur Black</h5>
									<div class="card-text d-flex justify-content-between">
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Maroon</font></li>
                    <li><B>Size :  </B><font color="red">mini</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Navy Blue </font></li>
                    <li><B>Size :  </B><font color="red">mini</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
				 ...
				 <p>
                  <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Gotcha Huncha Cardholder Fur Navy Bleu</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿350.00</p>
										<p class="line-through">฿375.00</p>
									</div>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">LightGrey</font></li>
                    <li><B>Size :  </B><font color="red">mini</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">13</font></li>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Mustard</font></li>
                    <li><B>Size :  </B><font color="red">mini</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">15</font></li>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B>Color :  </B><font color="red">Vanilla Cream</font></li>
                    <li><B>Size :  </B><font color="red">mini</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">15</font></li>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase">Gotcha Huncha Cardholder Printed Black</h2>
                  <p class="item-intro text-muted">WOMEN กระเป๋าสตางค์</p>
				   <div class="caption">
				  ...
				  <ul class="list-inline">
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    <li><B><B>Color :  </B><font color="red">Black</font></li>
                    <li>Size :  </B><font color="red">mini</font></li>
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">12</font></li>
					<br><B>Details</B>
				 ...
				 <p>
                  <h3 align = 'center'><button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fas fa-times"></i>ปิด</button>
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Gotcha Huncha Cardholder Printed Black</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">฿350.00</p>
										<p class="line-through">฿375.00</p>
									</div>
              ...
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
				 ...
				 <li><B>Brand :  </B><font color="red">Gotcha(ก๊อตช่า)</font></li>
                    ...
                    <li><B>Material :  </B><font color="red">Pu leather</font></li>
					<li><B>Use :  </B><font color="red">Official</font></li>
					<li><B>Number of products :  </B><font color="red">11</font></li>
					<br><B>Details</B>
				<br>
				 <p>กระเป๋าสตางค์ปั๊มลาย ใส่แบงค์แบบพับครึ่งได้ กระเป๋าใส่การ์ดได้ 8 ใบ </p>
